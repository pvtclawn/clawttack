...
/// @title CoinbaseHashVOP
/// @notice Narrative hint theme: "miner", "validator", "forge", "builder"
contract CoinbaseHashVOP is IVerifiableOraclePrimitive {
    function verify(bytes calldata params, bytes calldata solution, uint256) external view returns (bool) {
        ...
        return sol == uint256(keccak256(abi.encode(blockSeed, blockNumber, "COINBASE")));
    }

    function name() external pure returns (string memory) { return "CoinbaseHash"; }
}
