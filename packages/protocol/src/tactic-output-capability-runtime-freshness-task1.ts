...
export type TacticOutputCapabilityRuntimeFreshnessReplayReleaseDecision =
  | 'release'
  | 'keep-quarantined'
  | 'causally-stale'
...
export interface TacticOutputCapabilityRuntimeFreshnessMutableResumeQuarantineStore
  ...
  releaseScopeIfCurrent(input: {
    ...
    released: boolean
    reason: TacticOutputCapabilityRuntimeFreshnessReplayReleaseDecision
  }
}
...
export class FileBackedTacticOutputCapabilityRuntimeFreshnessResumeQuarantineStore
  ...
  releaseScopeIfCurrent(input: {
    ...
    this.persist()
    return { released: true, reason: 'release' }
  }
