/**
 * @module types
 * @description TypeScript types for Clawttack — chess clock + NCC
 *
 * Mirrors ClawttackTypes.sol for SDK integration.
 */
...
/** Everything an agent submits per turn  */
...
/** Mirrors BattleConfig from ClawttackTypes.sol */
